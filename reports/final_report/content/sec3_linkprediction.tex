...
\begin{itemize}
    \item Support Vector Machines (SVM) \cite{SVM}, as linear baseline; 
    \item Random Forest (RF) \cite{RandomForest}, for its really fast computation; 
    \item Multilayer Perceptron (MLP) \cite{MLP}, for accurate predictions.
\end{itemize}