...
\begin{itemize}
    ...
    \item Deep Variational Network Embedding in Wasserstein Space (DVNE) \cite{DVNE}, a deep encoding method using a Variational Autoencoder. This method has a particular approach of
