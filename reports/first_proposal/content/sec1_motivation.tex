...
To address this challenge, graph embedding techniques have been developed to learn low-dimensional vector representations of nodes, edges, or entire graphs while preserving their topological properties. \\
Consequently, in order to design an effective graph embedding technique, it is necessary to consider several criteria \cite{baptista2023zoo}. 
