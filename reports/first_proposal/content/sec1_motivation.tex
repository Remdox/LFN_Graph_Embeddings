...
An embedding method is considered adaptable if it can be utilized for various data and tasks without the need for retraining.
...
Eventually, we would like to assess the adaptability of these techniques when they are applied to different tasks.\\
