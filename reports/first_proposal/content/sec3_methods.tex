...
\begin{itemize}
    \item Node2Vec \cite{node2vec}, a shallow encoding which is a tunable version of the DeepWalk algorithm, which is often used in the scientific literature as the baseline for comparing node embedding methods.
    \item LINE \cite{LINE}, a shallow encoding which is am highly-scalable approximation algorithm.
